export default function IconDel() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_68_4054)">
        <path d="M4 7H20" stroke="#F3F8FB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 11V17" stroke="#F3F8FB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14 11V17" stroke="#F3F8FB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path
